...
class FrameFilter(django_filters.FilterSet):
    ...
    OBSTYPE = django_filters.CharFilter(field_name='configuration_type', lookup_expr='iexact')
    PROPID = django_filters.CharFilter(field_name='proposal_id', lookup_expr='icontains')
    INSTRUME = django_filters.CharFilter(field_name='instrument_id', lookup_expr='iexact')
    SITEID = django_filters.CharFilter(field_name='site_id', lookup_expr='iexact')
    TELID = django_filters.CharFilter(field_name='telescope_id', lookup_expr='iexact')
    FILTER = django_filters.CharFilter(field_name='primary_optical_element', lookup_expr='iexact')
