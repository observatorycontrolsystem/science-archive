# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2015-12-17 00:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', pgsphere.fields.SBoxField(null=True)),
                ...
                ('OBSTYPE', models.CharField(choices=[('BIAS', 'BIAS'), ('DARK', 'DARK'), ('EXPERIMENTAL', 'EXPERIMENTAL'), ('EXPOSE', 'EXPOSE'), ('SKYFLAT', 'SKYFLAT'), ('STANDARD', 'STANDARD')], default='', help_text='Type of observation. FITS header: OBSTYPE', max_length=20)),
