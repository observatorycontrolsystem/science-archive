# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-02-05 23:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PROPID', models.CharField(blank=True, default='', help_text='Textual proposal id. FITS header: PROPID', max_length=200)),
                ('INSTRUME', models.CharField(default='', help_text='Instrument used. FITS header: INSTRUME', max_length=10)),
                ('OBJECT', models.CharField(blank=True, db_index=True, default='', help_text='Target object name. FITS header: OBJECT', max_length=200)),
